          ...
          try {
            withKubeConfig([credentialsId: 'kubeconfig']) {
			 ...
			 post{
              ...
              perfReport filterRegex: '', modeThroughput: true, showTrendGraphs: true, sourceDataFiles: '/var/lib/jenkins/workspace/mine-project/apache-jmeter-5.5/bin/JenkinsJmeter.jtl'
       }
   }
