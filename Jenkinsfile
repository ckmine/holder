          ...
          try {
            withKubeConfig([credentialsId: 'kubeconfig']) {
			 ...
			 post{
              ...
              perfReport excludeResponseTime: true, failBuildIfNoResultFile: false, filterRegex: '', modePerformancePerTestCase: true, modeThroughput: true, showTrendGraphs: true, sourceDataFiles: '/var/lib/jenkins/workspace/mine-project/apache-jmeter-5.5/bin/JenkinsJmeter-1.jtl'
       }
   }
